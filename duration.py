...
s_point='2021-12-21T23:29'
d_point='2021-12-21T23:59'
# time.sleep(57600)
...
for day in range(0,365):
    ...
    try:
        ...
        body = {'query': {'bool': {'must': [{'match_all': {}},
                                            {'range': {'@timestamp': {'gte': '{}T20:35:00.000Z'.format(_start_),
                                                                      'lt': '{}T20:25:00.000Z'.format(_end)}}}]}}}
        # body = {'query': {'bool': {'must': [{'match_all': {}},
        #                                     {'range': {'@timestamp': {'gte': '2021-09-12T12:00:00.000Z'.format(_start_),
    ...
    if exist!=0:
        ...
        if exist!=0:
                                ...
                                if s_fill == 1 and e_fill == 1:
                                    ...
                                    if len(epgy) != 0 and e_flag == 1:
                                        ...
                                        try:
                                            ...
                                            if len(st) == 0 and len(
                                                    epgy[(epgy['s_time'] <= t_pause) & (epgy['s_time'] >= t_play)]) != 0:
                                                st_h = epgy[(epgy['s_time'] <= t_pause) & (epgy['s_time'] >= t_play)]
                                                st = st_h
                                        ...
                                        try:
                                            ...
                                            ind_h = 0
                                            if len(en) == 0 and len(
                                                    epgy[(epgy['e_time'] <= t_pause) & (epgy['s_time'] >= t_play)]) != 0:
                                                en_h = epgy[(epgy['e_time'] <= t_pause) & (epgy['s_time'] >= t_play)]
                                                en = en_h
                                                t_pause = en_h.iloc[len(en) - 1]['e_time']
                                                ind_h = (en.index.values)[-1]
                                            elif len(en) == 0 and len(
                                                    epgy[
                                                        (epgy['e_time'] <= t_pause) & (epgy['e_time'] >= t_play)]) != 0:
                                                en_h = epgy[(epgy['e_time'] <= t_pause) & (epgy['e_time'] >= t_play)]
                                                # print('en_h')
                                                # print(en_h)
                                                en = en_h
                                                t_pause = en_h.iloc[len(en) - 1]['e_time']
                                        ...
                                        if len(epgx) > 2:
                                            epg.loc[ind0 + 1:ind1 - 1, 'dur'] = epg.loc[ind0 + 1:ind1 - 1, 'dur'] + epg.loc[
                                                                                                                    ind0 + 1:ind1 - 1,
                                                                                                                    'dif']
                                ...
                                if s_fill == 1 and e_fill == 1:
                                    ...
                                    if len(epgy) != 0 and e_flag == 1:
                                        ...
                                        try:
                                            ...
                                            ind_h = 0
                                            if len(en) == 0 and len(
                                                    epgy[(epgy['e_time'] <= t_pause) & (epgy['e_time'] >= t_play)]) != 0:
                                                en_h = epgy[(epgy['e_time'] <= t_pause) & (epgy['e_time'] >= t_play)]
                                                en = en_h
                                                t_pause = en_h.iloc[len(en) - 1]['e_time']
                                                # print(t_pause)
            ...
            epg.to_excel(r'F:\clean_epg\epg_{}.xlsx'.format(lable), index=False, encoding='utf-8')
            epg.to_sql('duration', engine.connect(), if_exists='append', index=False)
            epg = epg.astype(str)
            ...
            for q in d_epg:
                msg2 = q
                print(msg2)
                channel.basic_publish(exchange='', routing_key='durvisit',properties=pika.BasicProperties(content_type='application/json') ,body=json.dumps(msg2,ensure_ascii = False))
